...
;;; Last Modified <michael 2016-01-03 00:34:30>
...
(defcfun "mbedtls_ctr_drbg_init" :void (ctx (:pointer (:struct mbedtls_ctr_drbg_context))))
...
(defcfun "mbedtls_ctr_drbg_seed"
    :int
  (ctx (:pointer (:struct mbedtls_ctr_drbg_context)))
  (f_entropy :pointer)
  (entropy :pointer)
  (custom (:pointer :unsigned-char))
  (len size_t))
...
(defcfun "mbedtls_ctr_drbg_free" :void (ctx (:pointer (:struct mbedtls_ctr_drbg_context))))
...
(defcfun "mbedtls_ctr_drbg_set_reseed_interval" :void (ctx (:pointer (:struct mbedtls_ctr_drbg_context))) (interval :int))
...
(defcfun "mbedtls_ctr_drbg_reseed"
    :int
  (ctx (:pointer (:struct mbedtls_ctr_drbg_context)))
  (additional :string)
  (len size_t))
...
(defcfun "mbedtls_ctr_drbg_random" :int (p_rng :pointer) (output (:pointer :unsigned-char)) (output_len size_t))
